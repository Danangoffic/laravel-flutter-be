    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('dashboard.product.store') }}" class="w-full"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input placeholder="Product Name" type="text" name="name" id="" value="{{ old('name') }}"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <textarea required name="description" id=""
                                class="block w-full bg-gray-200 text-gray-800 border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-600">{!! old('description') !!}</textarea>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                        ...
                        <div class="w-full px-3">
                            ...
                            <select placeholder="Product Price" type="number" name="categories_id"
                                ...
                                @foreach ($category as $item)
                                    <option value="{{ $item->id }}" @if (old('categories_id') == $item->id) selected @endif
